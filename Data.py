...
#                        attribute_value = '\033[33m'+'too long to display...'+'\033[0m'
    ...
    def preprocess_exp(self):
        ...
        with open('./wtc_data/explanations2.txt','r') as file:
            ...
            exp_intseq = [self.tokenized_sentence_to_intseq(sentence,self.word2index) for sentence in exp_tokenized]
...
#            exp_vocab_dict = {word:ind+1 for ind,word in enumerate(exp_vocab)}
    ...
    def preprocess_questions(self):
        ...
        with open(filepath,encoding = 'utf-8') as file:
            ...
            cutoff_length = 150
            questions_intseq = self.convert_to_intseq(questions,word2index)
            ...
            answers_intseq = self.convert_to_intseq(answers_words,word2index)
            ...
            e.g. [[0,0,0,...,]]
            '''
            all_answer_options_intseq = [[self.tokenized_sentence_to_intseq(sentence,word2index) for sentence in part] for part in all_answer_options]
    ...
    def process_sentence(self,sentence):
        ...
        word_list = self.replace_unicode_symbols_and_numbers(sentence.lower())
