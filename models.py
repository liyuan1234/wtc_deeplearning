...
def cnn(data,num_hidden_units = 10):
    ...
    Cosine_similarity = Lambda(loss_functions.get_cosine_similarity ,name = 'Cosine_similarity')
    ...
    loss = Lambda(loss_functions.hinge_loss, name = 'loss')([pos_similarity,neg_similarity1])
    ...
    title = 'cnn'+str(num_hidden_units)
