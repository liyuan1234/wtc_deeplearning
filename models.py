...
def cnn(data,num_hidden_units = 10,dropout_type = None, reg = 0.00):
    ...
    def get_conv_model(num_hidden_units):
        biLSTM_num_hidden_units = num_hidden_units*2
        inputer = Input([None,biLSTM_num_hidden_units])
        input_representation = Reshape([-1,biLSTM_num_hidden_units,1])(inputer)
        conv2_output = Conv2D(filters = 2, kernel_size = [2,biLSTM_num_hidden_units], padding = 'valid', activation = 'tanh', data_format = 'channels_last')(input_representation)
        conv2_output = GlobalMaxPooling2D()(conv2_output)
        conv3_output = Conv2D(filters = 2, kernel_size = [3,biLSTM_num_hidden_units], padding = 'valid', activation = 'tanh', data_format = 'channels_last')(input_representation)
        conv3_output = GlobalMaxPooling2D()(conv3_output)
        conv4_output = Conv2D(filters = 2, kernel_size = [4,biLSTM_num_hidden_units], padding = 'valid', activation = 'tanh', data_format = 'channels_last')(input_representation)
        conv4_output = GlobalMaxPooling2D()(conv4_output)
        conv5_output = Conv2D(filters = 2, kernel_size = [5,biLSTM_num_hidden_units], padding = 'valid', activation = 'tanh', data_format = 'channels_last')(input_representation)
        conv5_output = GlobalMaxPooling2D()(conv5_output)
        conv6_output = Conv2D(filters = 2, kernel_size = [6,biLSTM_num_hidden_units], padding = 'valid', activation = 'tanh', data_format = 'channels_last')(input_representation)
        conv6_output = GlobalMaxPooling2D()(conv6_output)
        conv7_output = Conv2D(filters = 2, kernel_size = [7,biLSTM_num_hidden_units], padding = 'valid', activation = 'tanh', data_format = 'channels_last')(input_representation)
    ...
    pos_ans = Dropouter(0.5)(pos_ans)
    neg_ans1 = Dropouter(0.5)(neg_ans1)
    neg_ans2 = Dropouter(0.5)(neg_ans2)
    neg_ans3 = Dropouter(0.5)(neg_ans3)
...
def massive_cnn(data,num_hidden_units = 10,reg = 0.00):
    ...
    def get_conv_model(num_hidden_units):
        ...
        conv2_output = Conv2D(filters = 5, kernel_size = 2, padding = 'same', activation = 'tanh')(input_representation)
        conv2_output = GlobalMaxPooling1D()(conv2_output)
        conv3_output = Conv2D(filters = 5, kernel_size = 3, padding = 'same', activation = 'tanh')(input_representation)
        conv3_output = GlobalMaxPooling1D()(conv3_output)
        conv4_output = Conv2D(filters = 5, kernel_size = 4, padding = 'same', activation = 'tanh')(input_representation)
        conv4_output = GlobalMaxPooling1D()(conv4_output)
        conv5_output = Conv2D(filters = 5, kernel_size = 5, padding = 'same', activation = 'tanh')(input_representation)
        conv5_output = GlobalMaxPooling1D()(conv5_output)
        conv6_output = Conv2D(filters = 5, kernel_size = 6, padding = 'same', activation = 'tanh')(input_representation)
        conv6_output = GlobalMaxPooling1D()(conv6_output)
        conv7_output = Conv2D(filters = 5, kernel_size = 7, padding = 'same', activation = 'tanh')(input_representation)
...
#    def get_conv_model(num_hidden_units):
#        input_representation = Input(shape = [None,num_hidden_units*2])
#        conv2_output = Conv2D(filters = 2, kernel_size = 2, padding = 'same', activation = 'tanh')(input_representation)
#        conv2_output = GlobalMaxPooling1D()(conv2_output)
#        conv3_output = Conv2D(filters = 2, kernel_size = 3, padding = 'same', activation = 'tanh')(input_representation)
#        conv3_output = GlobalMaxPooling1D()(conv3_output)
#        conv4_output = Conv2D(filters = 2, kernel_size = 4, padding = 'same', activation = 'tanh')(input_representation)
#        conv4_output = GlobalMaxPooling1D()(conv4_output)
#        conv5_output = Conv2D(filters = 2, kernel_size = 5, padding = 'same', activation = 'tanh')(input_representation)
#        conv5_output = GlobalMaxPooling1D()(conv5_output)
#        conv6_output = Conv2D(filters = 2, kernel_size = 6, padding = 'same', activation = 'tanh')(input_representation)
#        conv6_output = GlobalMaxPooling1D()(conv6_output)
#        conv7_output = Conv2D(filters = 2, kernel_size = 7, padding = 'same', activation = 'tanh')(input_representation)
#        conv7_output = GlobalMaxPooling1D()(conv7_output)
#    #    conv8_output = Conv2D(filters = 2, kernel_size = 10, padding = 'same', activation = 'tanh')(input_representation)
#    #    conv8_output = GlobalMaxPooling1D()(conv8_output)
#    #    conv9_output = Conv2D(filters = 2, kernel_size = 15, padding = 'same', activation = 'tanh')(input_representation)
...
#    
#    conv_model = get_conv_model(num_hidden_units)
#    RNN = Bidirectional(GRU(num_hidden_units, name = 'answer_lstm', dropout = 0.5,recurrent_dropout = 0.0,return_sequences = True))
#    
#    Glove_embedding = Embedding(input_dim = reduced_embedding_matrix.shape[0],output_dim = reduced_embedding_matrix.shape[1], weights = [reduced_embedding_matrix], name = 'glove_embedding')
#    Glove_embedding.trainable = False
#    
