...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 31 10:13:30 2018
...
rep_explain_ques = Concatenate()([exp_rep,question_rep])
rep_explain_ques = Dropout(0.5)(rep_explain_ques)
rep_explain_ques = Dense(NUM_HIDDEN_UNITS*2)(rep_explain_ques)
rep_explain_ques = Dropout(0.5)(rep_explain_ques)
...
for i in range(num_iter):
    ...
    history = training_model.fit(x = X_train,y = dummy_labels_train,validation_data = [X_val,dummy_labels_val],batch_size = 256,epochs = 3)
...
print('=== time taken to run predictions is: {}'.format(time.time() - start_time))
...
save_model = 1
if save_model == 1:
    training_model.save('./saved_models/rnn4_30aug.h5py')  